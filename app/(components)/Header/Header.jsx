  ...
  return (
    <div className=" grid sm:grid-cols-2 mt-[100px] sm:mt-[226px] overflow-x-hidden">
      <div className="sm:ml-10 md:ml-40">
        ...
        <p className=" text-Accent font-sans text-center sm:text-start mb-[29px] text-[22px] font-normal leading-[30px]">
        ...
        <div class="flex justify-center items-center sm:items-start sm:justify-start">
          <div className="transition duration-500 mb-20 sm:mb-[319px] ease-in-out hover:bg-black hover:text-Accent2 active:bg-black active:text-Accent2 bg-Accent2 border-Accent2 w-[144px] h-[45px] mt-[20px] py-3 text-center rounded-md">
